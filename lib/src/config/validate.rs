...
use super::{ItemType, ParsedRegisteredItem, ExecutionType, RegisteredItem, ENV};
use crate::Error;

pub fn parse_configuration_item(itype: ItemType, map: &HashMap<String, Value>) -> Result<ParsedRegisteredItem, Error> {
